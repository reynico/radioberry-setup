...
El Yaesu FT-80c/FT-747/FT-747GX maneja los 6 filtros pasabajos a través de un contador BCD que convierte binario a decimal, el [μPD4028](1372-4028.pdf). Pero dado que el contador BCD está instalado en la main board, y la main board es mas probable que la eliminemos, este control de filtros, a diferencia del control de filtros del [Vertex VX1700](../filter-control-arduino-vx1700/), maneja los 6 filtros directamente a través de un [UDN2981](UDN2981.pdf) (la versión PNP del ULN2003). El programa para el Arduino convierte los datos binarios recibidos desde la Radioberry, usando el mismo protocolo que la Alex Filter Board. El control de filtros también controla el relay de TX/RX que está dentro del LPF.
